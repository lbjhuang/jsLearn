        ...
        function(e, t) { !
            function(e, t) {
                ...
                var n, r, i, o = e,
                    ...
                    M = null == o.opener && ( !! o.top && o != o.top || !!o.parent && o != o.parent),
                    ...
                    Y = ["flash-sandboxed", "flash-disabled", "flash-outdated", "flash-insecure", "flash-unavailable", "flash-degraded", "flash-deactivated", "flash-overdue"],
                    X = new RegExp("^flash-(" + Y.map(function(e) {
                        return e.replace(/^flash-/, "")
                    }).join("|") + ")$"),
                    Z = new RegExp("^flash-(" + Y.filter(function(e) {
                    ...
                    te = function(e, t) {
                        ...
                        if ("string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || w(e).forEach(function(t) {
                            ...
                            if (a.ready && q.ready && Ke.emit({
                                ...
                                }), r = 0, i = Y.length; r < i; r++) if (!0 === q[Y[r].replace(/^flash-/, "")]) {
                                    Ke.emit({
                                        type: "error",
                                        name: Y[r]
                                    });
                    ...
                    le = function(e, t) {
                        ...
                        for (var r in n)"string" == typeof r && r && x.call(n, r) && "string" == typeof n[r] && n[r] && (B[r] = Ye(n[r]))
                    },
                    ce = function(e) {
                        void 0 === e ? (j(B), z = null) : "string" == typeof e && x.call(B, e) && delete B[e]
                    },
                    ue = function(e) {
                    ...
                    me = function(e) {
                        ...
                        if ("string" == typeof e && e ? (t = e, e = {}) : "object" == typeof e && e && "string" == typeof e.type && e.type && (t = e.type), t) {
                            ...
                            "error" === e.type && (X.test(e.name) && E(e, {
                                target: null,
                    ...
                    xe = function(e) {
                        var t = null;
                        return (!1 === M || e && "error" === e.type && e.name && -1 !== V.indexOf(e.name)) && (t = !1),
                            t
                    },
                    Te = function(e) {
                        ...
                        switch (delete e._source, e.type) {
                            ...
                            case "_mouseover":
                                Ke.focus(t),
                                !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !A(e.relatedTarget, t) && Ce(E({},
                                    e, {
                                        type: "mouseenter",
                                        bubbles: !1,
                                        cancelable: !1
                    ...
                    rt = function(e, t) {
                        ...
                        if ("string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || w(e).forEach(function(t) {
                            ...
                            if (a.ready && q.ready && this.emit({
                                ...
                                for (r = 0, i = Y.length; r < i; r++) if (q[Y[r].replace(/^flash-/, "")]) {
                                    this.emit({
                                        type: "error",
                                        name: Y[r],
                                        client: this
    ...
    define("newweb/common/jquery-1.7", [],
        function(e, t) {
            return function(e, t) {
                    ...
                    when: function(e) {
                        ...
                        if (r > 1) {
                            for (; n < r; n++) t[n] && t[n].promise && R.isFunction(t[n].promise) ? t[n].promise().then(function(e) {
                                    return function(n) {
                                        t[e] = arguments.length > 1 ? M.call(arguments, 0) : n,
                                        --o || a.resolveWith(a, t)
                                    }
                                } (n), a.reject,
                                function(e) {
                        ...
                        propHooks: {
                            tabIndex: {
                                get: function(e) {
                                    ...
                                    return n && n.specified ? parseInt(n.value, 10) : Y.test(e.nodeName) || X.test(e.nodeName) && e.href ? 0 : t
                                }
                            }
                        }
                    }),
                    ...
                    R.each(["height", "width"],
                        function(e, t) {
                            R.cssHooks[t] = {
                                get: function(e, n, r) {
                                    var i;
                                    if (n) return 0 !== e.offsetWidth ? v(e, t, r) : (R.swap(e, Me,
                                        function() {
                                            i = v(e, t, r)
                                        }), i)
                                },
                ...
                L.defaultView && L.defaultView.getComputedStyle && (je = function(e, n) {
                    var r, i, o;
                ...
                L.documentElement.currentStyle && (Ae = function(e, t) {
                    ...
                    R.fn.extend({
                        ...
                        serializeArray: function() {
                            return this.map(function() {
                                ...
                                return this.name && !this.disabled && (this.checked || Qe.test(this.nodeName) || Ye.test(this.type))
                            }).map(function(e, t) {
                                var n = R(this).val();
    ...
    define("newweb/common/requestMoreTrans", ["./md5", "./jquery-1.7", "./utils"],
        function(e, t) {
            ...
            t.asyRequest = function(e) {
                var t = r.deEight("rY0D^0'nM0}g5Mm1z%1G4"),
                    o = e.i,
                    a = "" + ((new Date).getTime() + parseInt(10 * Math.random(), 10)),
                    s = n.md5("fanyideskweb" + o + a + t);
                i && i.abort(),
                    i = n.ajax({
                        type: "POST",
        ...
        function(e, t) {
            ...
            function r(e) {
                for (var t = e.translateResult,
                         n = [], r = 0, i = L(A.state.type) ? " ": "", o = 0; o < t.length; o++) {
                    var a = t[o],
                        s = [];
                    r += a.length;
                ...
                y.clog("&sentence_number=" + r + "&type=" + A.state.type);
                var f = n.join("");
                w.html(f),
                    A.state.originalTgt = w.text(),
                    A.state.smallFont ? w.addClass("input__target__text--small") : w.removeClass("input__target__text--small")
            }
            function i() {
                var e = u.trim(b.val());
                e = e.replace(/\n/g, "").replace(/\r\n/g, ""),
            ...
            function a(e) {
                e && 0 == e.errorCode ? (A.state = u.extend(A.state, e), o(A.state.type), r(e), e.smartResult && e.translateResult.length > 0 && e.translateResult[0].length > 0 ? (y.clog("RESULT_DICT_SHOW"), g.render(e.translateResult[0][0].src, e.smartResult)) : g.hide(), d.showVoice(A.state.type)) : w.html(""),
                    D()
            }
            function s(e, t) {
            ...
            function l(e, t) {
                "zh-CHS2en" != A.state.type && "en2zh-CHS" != A.state.type || (u(e).hasClass("show-suggest") ? c() : (u(e).addClass("show-suggest"), N.hide(), v.asyRequest({
                    i: t.i,
                    client: E,
                    tgt: t.tgt,
                    from: t.from,
                    ...
                    success: function(t) {
                        ...
                        var o = t.translateResult,
                            a = [];
                        y.clog("&mul_result_number=" + o.length + "&type=" + A.state.type);
            ...
            var y = e("./log"),
                ...
                k = "",
                N = u("#fanyiSuggest"),
                j = navigator.userAgent.indexOf("Trident") > -1,
                A = e("./TranslateState"),
                O = f.deEight("rY0D^0'nM0}g5Mm1z%1G4"),
                L = function(e) {
                ...
                function() {
                    ...
                    w.delegate("span", "mouseover",
                        function() {
                            if (!h) {
                                ...
                                j || b.selectRange({
                                    ...
                                    n.addClass("hover"),
                                    y.clog("MATCHING_HOVER&type=" + A.state.type)
                            }
                        }),
                            ...
                            function() {
                                if (!h) {
                                    ...
                                    j || b.selectRange({
                                        ...
                                        y.clog("MUL_RESULT_CLICK&type=" + A.state.type);
                        ...
                        w.delegate("span", "mouseout",
                            function() {
                                h || (u("#transTarget span.hover").removeClass("hover"), j || b.selectRange({
                                    start: 0,
                                    end: 0
                                }), r())
                            }),
